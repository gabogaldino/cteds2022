...
namespace deploy_sample.Repositories
{
    ...
    internal class ProductRepository : IProduct
    {
        ...
        /// </summary>
        //private readonly string stringConexao = "Data source=DESKTOP-9P9G7B0\\SQLEXPRESS; initial catalog=Catalog; user id=sa; pwd=cteds2022;";
        //private readonly string stringConexao = "Data source=DESKTOP-9P9G7B0\\SQLEXPRESS; initial catalog=Catalog; integrated security=true;";
        private readonly string stringConexao = "Server=tcp:cteds.database.windows.net,1433;Initial Catalog=Catalog;Persist Security Info=False;User ID=cteds-admin;Password=deploy-sample@2022;MultipleActiveResultSets=False;TrustServerCertificate=False;Connection Timeout=30;";
